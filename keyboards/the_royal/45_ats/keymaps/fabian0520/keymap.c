...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_split_space(
        ...
        KC_TAB,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_QUOTE,   KC_ENTER,       KC_PGDN,
        KC_LSFT,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, RSFT_T(KC_SLSH),        KC_UP,     TO(_GAM),
    ...
    [_FN] = LAYOUT_split_space(
        XXXXXX,  KC_EXLM,    KC_AT,    KC_HASH,    KC_DOLLAR,    KC_PERCENT,   KC_CIRC,    KC_AMPR,    KC_ASTR,    KC_LBRC,    KC_RBRC,    KC_BSLS, XXXXXX,    KC_HOME,
        XXXXXX,   KC_1,        KC_2,     KC_3,       KC_4,       KC_5,      KC_6,       KC_7,       KC_8,       KC_9,       KC_0,          KC_ENTER,       KC_END,
        XXXXXX,     KC_LPRN,    KC_RPRN,    KC_SCLN,    KC_DOT,    XXXXXX,  KC_MINS,     KC_PLUS,   KC_ASTR,  KC_SLSH,   KC_EQL,              XXXXXX,       KC_NO,
    ...
    [_LN] = LAYOUT_split_space(
        KC_PWR,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    XXXXXX,    XXXXXX,    XXXXXX,    XXXXXX,    KC_MPRV, KC_MNXT,    KC_VOLU,
        KC_SLEP,   KC_F7,    KC_F8,    KC_F9,    KC_F10,    KC_F11,    KC_F12,    XXXXXX,    XXXXXX,    XXXXXX,    XXXXXX,   KC_MPLY,         KC_VOLD,
    ...
    [_GAM] = LAYOUT_split_space(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,            KC_SPACE,           KC_SPACE,            MO(_FN),   MO(_LN),  KC_LEFT, KC_DOWN, KC_RIGHT
    )
};
    ...
    /* Main Numbers, Symbols & Function Layer (MOMENTARY)
     * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┐   ┌───┐
     * │Br+│QWE│COL│STR│   │   │RGB│RGB│RGB│VUP│   │       │   │Hme│
     * ├───┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──────┤   ├───┤
     * │Br- │UCM│GAM│   │   │   │RGB│RGB│RGB│VDW│   │ ???  │   │End│
     * ├────┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴──┬───┘   ├───┤
     * │      │   │   │   │   │   │RGB│RGB│RGB│MUT│    │ ┌───┐ │   │
     * ├────┬─┴─┬─┴──┬┴───┴───┴─┬─┴───┴──┬┴───│───┴┬───┘ │   │ └───┘
     * │    │   │    │          │        │    │    │ ┌───┤───├───┐
