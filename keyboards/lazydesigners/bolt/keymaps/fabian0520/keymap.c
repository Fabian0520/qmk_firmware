...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK]=LAYOUT(
		...
		KC_LSFT,            KC_Z,     KC_X,   KC_C,   KC_V,    KC_B,           KC_NO,  KC_K,   KC_M,  MY_COMM,  MY_DOT,   KC_RSFT, KC_LSFT,
		KC_LCTL,  KC_LGUI,  KC_LALT,        NUM_SPC,	          MOV_ENT , KC_RALT,                    KC_RGUI,  KC_RCTL, KC_RCTL
    ),
    ...
    [_MOV]=LAYOUT(
		KC_TRNS,  KC_PGUP,   KC_HOME,   KC_UP  ,   KC_END ,    KC_NO  ,          KC_NO,   i3_S_7,  i3_S_8,  i3_S_9,  KC_NO,   KC_NO,
    ...
    [_SYM]=LAYOUT(
		RESET  ,  KC_F12,   KC_F11,   KC_F10,   KC_F9,   KC_NO,          KC_PLUS,   KC_LBRC,  KC_RBRC, KC_LT  , KC_GT  ,  KC_TRNS,
    ...
    [_ADJUST]=LAYOUT(
		SCRE_UP,  DF(_QWERTY),   DF(_COLEMAK),   X(STAR),   X(SMILE),   KC_NO,          RGB_TOG, RGB_HUI,  RGB_SAI, RGB_VAI, KC_NO  ,  RESET,
		SCRE_DN,  UC_MOD ,       KC_NO ,         KC_NO ,    KC_NO,      KC_NO,          KC_NO,   RGB_HUD,  RGB_SAD, RGB_VAD, KC_NO,    KC_NO,
